...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="GloVe-mean (parameter-free) baseline on STS-12..STS-16 "
...
def main() -> None:
    ...
    train_dataset = SentencePairDataset(train_records, word_to_idx, score_scale=args.score_scale)
    test_dataset = SentencePairDataset(test_records, word_to_idx, score_scale=args.score_scale)
