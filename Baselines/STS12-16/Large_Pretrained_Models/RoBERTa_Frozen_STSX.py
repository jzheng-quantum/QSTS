...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="RoBERTa-frozen baseline on STS-12..STS-16 under the LOO pooled STS protocol."
    )
    parser.add_argument(
        "--train_files",
        type=str,
...
def main() -> None:
    ...
    variant_tag    = f"frozen_{args.pooling}pool_LOO"
